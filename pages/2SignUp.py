...
conn = pymongo.MongoClient("mongodb+srv://sk3538970_db_user:Yn1qj1wb3oJ4z6K1@pyversedb.bxahnpm.mongodb.net/ojt?retryWrites=true&w=majority")
...
if b1:
    if t1 == "" or t2 == "" or t3 == "" or t4 == "" or t5 == "":
        ...
        try:
            server.sendmail("sk3538970@gmail.com", t5, "Welcome to pyverse,your account has been created successfully.")
            st.success(f"📧 Email sent to {t5}")
        except Exception as e:
            st.error(f"❌ Failed to send email: {e}")
        st.success("✅ Account Created Successfully")

st.markdown("""
  <div style="text-align:left; color:#9CA3AF; margin-top:20px;">
   Already a member?
  </div>
""", unsafe_allow_html=True)
