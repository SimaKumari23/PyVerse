...
with left:
   ...
   .inner-card {
    ...
    <p style="color:#9CA3AF;"> Learn Python and Data Structures & Algorithms through structured tutorials, hands-on programs, coding exercises and quiz sessions.</p>
    <div class="inner-card">
    <h3>What you'll get</h3>
    <p>step-by-step Python&DSA tutorials</p>
...
with col1:
    ...
    <div class="card">
        ...
        <p style="color:#9CA3AF;">Learn python programming</p>
    </div>
    """, unsafe_allow_html=True)
...
with col2:
    ...
    <div class="card">
        ...
        <p style="color:#9CA3AF;">Learn dsa programming</p>
    </div>
    """, unsafe_allow_html=True)
